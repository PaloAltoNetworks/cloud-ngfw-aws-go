...
func (c *Client) List(ctx context.Context, input ListInput) (ListOutput, error) {
	c.client.Log(http.MethodGet, "list rulestack %q intelligent feeds", input.Rulestack)
...
func (c *Client) Create(ctx context.Context, input Info) error {
	c.client.Log(http.MethodPost, "create rulestack %q intelligent feed: %s", input.Rulestack, input.Name)
...
func (c *Client) Read(ctx context.Context, input ReadInput) (ReadOutput, error) {
	c.client.Log(http.MethodGet, "describe rulestack %q intelligent feed: %s", input.Rulestack, input.Name)
...
func (c *Client) Update(ctx context.Context, input Info) error {
	...
	c.client.Log(http.MethodPut, "updating rulestack %q intelligent feed: %s", input.Rulestack, name)
...
func (c *Client) Delete(ctx context.Context, stack, name string) error {
	c.client.Log(http.MethodDelete, "delete rulestack %q intelligent feed: %s", stack, name)

	_, err := c.client.Communicate(
		ctx,
		permissions.Rulestack,
		http.MethodDelete,
		[]string{"v1", "config", "rulestacks", stack, "feeds", name},
		nil,
		nil,
		nil,
	)
